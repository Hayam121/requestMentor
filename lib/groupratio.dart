...
class groupratio extends StatefulWidget {
  const groupratio({super.key});

  @override
  State<groupratio> createState() => _groupratioState();
}

class _groupratioState extends State<groupratio> {
      ...
      Padding(
        ...
        child: Form(
            ...
            child: Column(
              crossAxisAlignment: CrossAxisAlignment.start,
              children: [
                  Text('How Many Trainees Will be in the group?',style: TextStyle(color:Color(0xff206F7E),fontSize: 20,fontWeight: FontWeight.bold)),
                TextFormField(
            ...
            borderRadius: BorderRadius.all(
              Radius.circular(15),
                  ...
                  validator: (value) {
                    if (value!.isEmpty) {
                      return 'Please enter the number of Trainees';
                    }
                    return null;
                  },
                  onSaved: (value) {
